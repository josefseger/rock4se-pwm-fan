...
STATE_TOPIC=rock4se/fan/state
AVAILABILITY_TOPIC=rock4se/fan/availability
...
publish_discovery() {
  mqtt_pub -r -t homeassistant/sensor/rock4se_cpu_temperature/config -m \
'{"name":"CPU Temperature","unique_id":"rock4se_cpu_temperature","state_topic":"rock4se/fan/state","value_template":"{{ value_json.temperature }}","unit_of_measurement":"°C","device_class":"temperature","state_class":"measurement","availability_topic":"rock4se/fan/availability","payload_available":"online","payload_not_available":"offline","device":{"identifiers":["rock4se_pwm_fan"],"name":"ROCK 4SE PWM Fan","manufacturer":"Radxa","model":"ROCK 4 SE"}}'
  mqtt_pub -r -t homeassistant/sensor/rock4se_fan_speed/config -m \
'{"name":"Fan Speed","unique_id":"rock4se_fan_speed","state_topic":"rock4se/fan/state","value_template":"{{ value_json.speed }}","unit_of_measurement":"%","state_class":"measurement","availability_topic":"rock4se/fan/availability","payload_available":"online","payload_not_available":"offline","device":{"identifiers":["rock4se_pwm_fan"],"name":"ROCK 4SE PWM Fan","manufacturer":"Radxa","model":"ROCK 4 SE"}}'
  mqtt_pub -r -t homeassistant/sensor/rock4se_pwm_duty_cycle/config -m \
'{"name":"PWM Duty Cycle","unique_id":"rock4se_pwm_duty_cycle","state_topic":"rock4se/fan/state","value_template":"{{ value_json.duty_cycle }}","state_class":"measurement","availability_topic":"rock4se/fan/availability","payload_available":"online","payload_not_available":"offline","device":{"identifiers":["rock4se_pwm_fan"],"name":"ROCK 4SE PWM Fan","manufacturer":"Radxa","model":"ROCK 4 SE"}}'
  mqtt_pub -r -t homeassistant/binary_sensor/rock4se_fan_controller/config -m \
'{"name":"Fan Controller","unique_id":"rock4se_fan_controller","state_topic":"rock4se/fan/state","value_template":"{{ value_json.status }}","payload_on":"ON","payload_off":"OFF","device_class":"running","availability_topic":"rock4se/fan/availability","payload_available":"online","payload_not_available":"offline","device":{"identifiers":["rock4se_pwm_fan"],"name":"ROCK 4SE PWM Fan","manufacturer":"Radxa","model":"ROCK 4 SE"}}'
}
